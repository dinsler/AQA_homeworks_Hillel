"""
    Task1.Write an arithmetic function that takes 3 arguments: the first 2 are numbers,
    and the third is the operation to be performed on them.
    ...
    Describe the function in the attached file in such a way that all checks in the __main__ task_1
    block are performed correctly.
    DO NOT CALL THE FUNCTION YOURSELF I HAVE ALREADY DONE THIS IN "assert" STATEMENTS
"""
from typing import Union


def arithmetic(left_operand: int, right_operand: int, operation) -> Union[int, float, str]:
    """
